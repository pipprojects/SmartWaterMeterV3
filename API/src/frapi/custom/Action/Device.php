...
#class Action_Device extends Frapi_Action implements Frapi_Action_Interface
class Action_Device extends Extend_Interface implements Frapi_Action_Interface
{
    ...
    public function executePost()
    {
        ...
        list($this->data['content'][$this->name], $this->data['sql']) = $this->CommonSelect($WhereClausenull);
